    ...
    <div class="animated flipInY">
        ...
        <div class="box">
            <div class="box-header">
                ...
                <a href="{{route('admin.animales.create')}}" class="btn btn-info btn-lg"><i class="fa fa-folder-open-o"></i> Registar nuevo Animal</a><hr>
            </div><!-- /.box-header -->
                ...
                @foreach($animales as $animal)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.pesos.index') }}" class="btn btn-primary"><spam  class="glyphicon glyphicon-dashboard" aria-hidden="true"></spam></a>

                            <a href="{{ route('admin.historiales.index') }}" class="btn btn-info"><spam  class="glyphicon glyphicon-plus-sign" aria-hidden="true"></spam></a>
